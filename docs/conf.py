...
project = 'pyretrievals'
copyright = '2018, Jonas Hagen'
author = 'Jonas Hagen'
...
htmlhelp_basename = 'pyretrievalsdoc'
...
latex_documents = [
    (master_doc, 'pyretrievals.tex', 'pyretrievals Documentation',
     'Jonas Hagen', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyretrievals', 'pyretrievals Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyretrievals', 'pyretrievals Documentation',
     author, 'pyretrievals', 'One line description of project.',
     'Miscellaneous'),
]
